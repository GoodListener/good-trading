const shape = require('../cons/shape');
...
module.exports = class CoinAnalyser {
    constructor(model) {
        this.model = model;
        this.count = 0;
        this.totalRecord = {
        ...
        // 기울기
        this.ma10PricesIncline = 0;
        this.ma20PricesIncline = 0;
        this.ma30PricesIncline = 0;
        this.ma60PricesIncline = 0;
        this.ma120PricesIncline = 0;
        ...
        this.ma20Price = null;
        this.ma60Price = null;
        this.ma120Price = null;

        this.bollingerHighBand = [];
        this.bollingerLowBand = [];
        this.bollingerHigh = null;
        this.bollingerLow = null;

        this.max = null;
        this.min = null;
        this.avg = null;
        this.avg1perDownPrice = null;
        this.avg2perDownPrice = null;
        this.avg1perUpPrice = null;

        this.maState = 'none';
        this.buyHold = false;
        this.buyHoldPrice = null;
        this.buyWaiting = false;
        this.buyTiming = false;
        this.installmentBuyTiming = false; // 분할매수 타이밍
        this.installmentBuyCount = 0; // 분할매수 횟수

        this.sellHold = false;
        this.sellHoldPrice = null;
        this.sellTiming = false;
        this.installmentSellTiming = false; // 분할매도 타이밍
        this.installmentSellCount = 0; // 분할매도 횟수

        this.currentPrice = null; // 가장 최근 거래 값

        this.buyPrices = [];
        this.avgBuyPrice = null; // 평단
    }
